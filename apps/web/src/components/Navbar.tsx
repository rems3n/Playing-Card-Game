    ...
    <nav className="flex items-center justify-between px-6 h-12 bg-[var(--bg-secondary)] border-b border-[var(--border-subtle)]">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-1 text-sm">
          <a
            href="/"
            className="px-3 py-1.5 rounded text-white/90 hover:bg-white/[0.06] transition-colors"
          >
            Play
          </a>
          <a
            href="/leaderboard"
            className="px-3 py-1.5 rounded text-[var(--text-secondary)] hover:bg-white/[0.06] hover:text-white transition-colors"
          >
            Leaderboard
          </a>
        </div>
