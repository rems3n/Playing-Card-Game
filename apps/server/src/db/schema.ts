...
export const users = pgTable(
  ...
  (table) => [
    uniqueIndex("users_provider_unique").on(
      table.authProvider,
...
export const gamePlayers = pgTable(
  ...
  (table) => [
    index("game_players_participant_idx").on(table.participantId),
    uniqueIndex("game_players_seat_unique").on(
      table.gameId,
      table.seatPosition,
    ),
  ],
...
export const ratingHistory = pgTable(
  ...
  (table) => [
    uniqueIndex("rating_history_unique").on(
      table.userId,
      table.gameType,
      table.recordedAt,
    ),
